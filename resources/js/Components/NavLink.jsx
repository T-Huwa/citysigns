...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                "border w-full inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none " +
                (active
                    ? "border-indigo-400 dark:text-gray-100 focus:border-indigo-700 dark:border-indigo-600"
